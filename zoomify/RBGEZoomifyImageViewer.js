...
Z.initialize = function () {
  ...
  //Added by mp to allow image switching in place - something like a JQuery widget should use this returned function to set its done value to 0
...
Z.ZoomifyToolbar = function (tbViewport) {
    ...
    //console.log(Z.ToolbarDisplay)
		var background = new Z.Utils.Graphic("zbackground", Z.skinPath, tlbrSknArr[0], "1px", "1px", "0px", "0px");
	...
	function drawLayout (width, height) {
		...
		var bG = document.getElementById("zbackground");
    //console.log(bG)
	...
	function buttonHandlerAndGraphicsReset (targetBtn) {
		...
		if (targetBtn && Z.Utils.isStrVal(targetBtn.id)) {
			...
			} else if (targetBtn.id.indexOf("zbackground") != -1) {
				buttonsAllReset();
			}
		}
	};
